...
Hệ thống cho phép người dùng viết, lưu trữ, quản lý các dự án hướng đối tượng (OOP) đa tệp tin/nhiều package và thực thi mã nguồn Java trực tuyến trên nền tảng tương thích **Java 17 (JDK 17)** thông qua Wandbox API. Đây cũng là một dự án mẫu thực tế giúp các nhà phát triển chuyển đổi từ hệ sinh thái Java Spring Boot sang C# .NET Core một cách trực quan nhất.

---

## ✨ Các Tính Năng Nổi Bật

- 📂 **Trình quản lý tệp tin dự án (File Explorer)**: Hỗ trợ cấu trúc thư mục package phức tạp để áp dụng lập trình hướng đối tượng OOP (ví dụ: tạo tệp `animals/Dog.java` kế thừa `animals/Animal.java`).
- ⚡ **Biên dịch & Thực thi chuẩn Java 17**: Tích hợp Wandbox API chạy OpenJDK 21 tương thích ngược và cấu hình cờ `--release 17` ép buộc tuân thủ đúng chuẩn cú pháp Java 17.
- 🎨 **Monaco Editor cao cấp**: Bộ soạn thảo mã nguồn giống VS Code với theme tối (Dark Mode), hỗ trợ autocomplete, tô màu cú pháp (syntax highlighting) cho Java.
...
| **Execution Engine** | Wandbox API (OpenJDK 21 / Release 17) | Biên dịch và chạy mã nguồn Java. |
